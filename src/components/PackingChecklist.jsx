...
const PackingChecklist = () => {
  const checklistCategories = [
    {
      ...
      items: [
        ...
        {
          name: "Financial documents (bank statements, scholarship letters)",
          essential: true,
        },
        {
          name: "Medical prescriptions (with doctor's note)",
          essential: false,
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "Local currency (USD) - $200-500 for initial expenses",
          essential: true,
        },
        { name: "Travel checks (optional but recommended)", essential: false },
        {
          name: "Bank account details and contact information",
          essential: true,
        },
        {
          name: "Emergency contact numbers for financial institutions",
          essential: true,
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          name: "Winter clothing (jackets, sweaters, warm layers)",
          essential: true,
        },
        {
          name: "Traditional wear (optional but recommended)",
          essential: false,
        },
        {
          name: "Formal wear (for interviews, presentations)",
          essential: false,
        },
        {
          name: "Comfortable shoes (walking, sports, formal)",
          essential: true,
        },
        { name: "Underwear and socks (enough for 1-2 weeks)", essential: true },
        { name: "Sleepwear and loungewear", essential: true },
        {
          name: "Swimwear (Arizona has pools and water activities)",
          essential: false,
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Spices and masalas (garam masala, turmeric, etc.)",
          essential: true,
        },
        {
          name: "Basic utensils (pressure cooker, ladle, spatula)",
          essential: true,
        },
        { name: "Pans and cooking essentials", essential: true },
        { name: "Homemade snacks and comfort foods", essential: false },
        {
          name: "Rice and lentils (if you prefer specific varieties)",
          essential: false,
        },
        { name: "Tea/coffee (your preferred brands)", essential: false },
        {
          name: "Cooking oil (if you prefer specific types)",
          essential: false,
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Prescription medicines (with doctor's note)",
          essential: true,
        },
        {
          name: "Over-the-counter medicines (pain relief, cold medicine)",
          essential: true,
        },
        {
          name: "First aid kit (bandages, antiseptic, thermometer)",
          essential: true,
        },
        { name: "Vitamins and supplements", essential: false },
        { name: "Medical insurance documents", essential: true },
        {
          name: "Health records and vaccination certificates",
          essential: true,
        },
      ],
    },
  ...
  const packingTips = [
    {
      tip: "Start Early",
      description:
        "Begin packing 2-3 weeks before departure to avoid last-minute stress",
      icon: AlertCircle,
  ...
  const essentialCount = checklistCategories.reduce(
    (total, category) =>
      total + category.items.filter((item) => item.essential).length,
    0,
  );
  ...
  return (
    <section
      ...
      className="py-20 bg-gradient-to-br from-orange-50 via-white to-green-50 min-h-screen"
    >
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-8">
            Everything you need to pack for your journey to ASU from India. This
            comprehensive checklist ensures you don't forget any essential
            items.
          </p>
                  ...
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-lg text-gray-600">
                        {category.items.filter((item) => item.essential).length}{" "}
                        essential items
                      </CardDescription>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {category.items.map((item, itemIndex) => (
                      <motion.div
                        ...
                        transition={{
                          duration: 0.5,
                          delay: 0.4 + categoryIndex * 0.2 + itemIndex * 0.05,
                        }}
                        className={`flex items-center space-x-3 p-4 rounded-lg ${
                          item.essential ? "bg-white  shadow-md" : "bg-gray-50 "
                        }`}
                      >
                        <div
