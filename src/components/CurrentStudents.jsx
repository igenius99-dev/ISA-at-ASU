...
const CurrentStudents = () => {
  ...
  const upcomingEvents = [
    {
      ...
      description:
        "Join us for the biggest Diwali celebration at ASU with traditional food, performances, and fireworks.",
      category: "Cultural",
      attendees: "500+",
      icon: Star,
    ...
    },
    {
      ...
      description:
        "Industry expert discusses the future of AI in healthcare and career opportunities.",
  ...
  const resources = [
    ...
    },
    {
      ...
      items: ["Resume templates", "Interview preparation", "Job opportunities"],
    },
    {
      icon: Heart,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Your ISA community is here to support your academic journey and
            cultural connections at ASU.
          </p>
        </motion.div>
              ...
              >
                <Card className="h-full hover:shadow-xl transition-all duration-300 border-0 group cursor-pointer">
                  <CardHeader className="text-center">
                    <div
                      className={`w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-br ${action.color} flex items-center justify-center group-hover:scale-110 transition-transform`}
                    >
                ...
                <Card className="h-full hover:shadow-xl transition-all duration-300 border border-gray-200 group cursor-pointer">
                  <CardHeader>
                    <div className="flex items-start justify-between mb-4">
                      <div
                        className={`w-12 h-12 rounded-full bg-gradient-to-br ${event.color} flex items-center justify-center`}
                      >
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Access helpful resources to support your academic and personal
              growth.
            </p>
          </div>
