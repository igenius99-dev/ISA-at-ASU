  ...
  return (
    <section id="about" className="py-20 bg-white/50">
      <div className="container mx-auto px-4">
        ...
        >
          <h3 className="text-3xl font-bold text-gray-800 mb-12">Our Core Values</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { icon: BookOpen, text: "Education" },
              { icon: Heart, text: "Community" },
              { icon: Globe, text: "Diversity" },
              { icon: Handshake, text: "Service" }
            ].map((value, index) => (
              <motion.div
                key={value.text}
              ...
              >
                <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-saffron to-orange rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
